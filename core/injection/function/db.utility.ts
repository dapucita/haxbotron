...
export async function createSuperadminDB(key: string, description: string): Promise<void> {
    try {
        const result = await axios.post(dbConnAddr + 'superadmin/', {key: key, description: description});
...
export async function readSuperadminDB(key: string): Promise<string | undefined> {
    try {
        const result = await axios.get(dbConnAddr + 'superadmin/' + key);
...
export async function deleteSuperadminDB(key: string): Promise<void> {
    try {
        const result = await axios.delete(dbConnAddr + 'superadmin/' + key);
...
export async function createBanlistDB(banList: BanList): Promise<void> {
    try {
        const result = await axios.post(dbConnAddr + 'banlist/', banList);
        if (result.status === 204 && result.data) {
...
export async function readBanlistDB(playerConn: string): Promise<BanList | undefined> {
    try {
        const result = await axios.get(dbConnAddr + 'banlist/' + playerConn);
        if (result.status === 200 && result.data) {
...
export async function updateBanlistDB(banList: BanList):Promise<void> {
    try {
        const result = await axios.put(dbConnAddr + 'banlist/' + banList.conn, banList);
        if (result.status === 204 && result.data) {
...
export async function deleteBanlistDB(playerConn: string): Promise<void> {
    try {
        const result = await axios.delete(dbConnAddr + 'banlist/' + playerConn);
        if (result.status === 204) {
...
export async function createPlayerDB(player: PlayerStorage): Promise<void> {
    try {
        const result = await axios.post(dbConnAddr + 'player/', player);
        if (result.status === 204 && result.data) {
...
export async function readPlayerDB(playerAuth: string): Promise<PlayerStorage | undefined> {
    try {
        const result = await axios.get(dbConnAddr + 'player/' + playerAuth);
        if (result.status === 200 && result.data) {
...
export async function updatePlayerDB(player: PlayerStorage): Promise<void> {
    try {
        const result = await axios.put(dbConnAddr + 'player/' + player.auth, player);
        if (result.status === 204 && result.data) {
...
export async function deletePlayerDB(playerAuth: string): Promise<void> {
    try {
        const result = await axios.delete(dbConnAddr + 'player/' + playerAuth);
        if (result.status === 204) {
